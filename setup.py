...
setup(
    ...
    url='https://github.com/smetj/wishbone-encode-influxdb',
    download_url='https://github.com/smetj/wishbone-encode-influxdb/tarball/master',
    ...
    entry_points={
        'wishbone.encode': [
            'influxdb=wishbone_encode_influxdb:InfluxDB',
        ]
    }
)
